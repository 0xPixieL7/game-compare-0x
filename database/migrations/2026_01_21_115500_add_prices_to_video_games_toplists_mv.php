    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            WITH game_prices AS (
                SELECT 
                    video_game_id, 
                    MIN(amount_minor) FILTER (WHERE currency = 'USD') as min_price_usd,
                    MIN(amount_minor) FILTER (WHERE currency = 'EUR') as min_price_eur
            ...
            FROM (
                ...
                LEFT JOIN game_prices gp ON gp.video_game_id = vgr.id
