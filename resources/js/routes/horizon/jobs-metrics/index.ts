...
* @route '//127.0.0.1:8000/horizon/api/metrics/jobs'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '//127.0.0.1:8000/horizon/api/metrics/jobs',
...
* @route '//127.0.0.1:8000/horizon/api/metrics/jobs/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '//127.0.0.1:8000/horizon/api/metrics/jobs/{id}',
} satisfies RouteDefinition<["get","head"]>
