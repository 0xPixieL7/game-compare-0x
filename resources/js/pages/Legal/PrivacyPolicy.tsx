                ...
                <Card className="mx-auto w-full max-w-4xl border-none shadow-none">
                    ...
                    <CardContent className="space-y-6 px-0 leading-7 text-foreground/90">
                        <section>
                            ...
                            <p>
                                Welcome to Game Compare ("Application"). We
                                ...
                                may provide when you visit the Application and
                        ...
                        <section>
                            ...
                            <p className="mb-2">
                                ...
                                about users of our Application, including:
                            </p>
                            <ul className="list-disc space-y-1 pl-6">
                                <li>
                                    <strong>Personal Information:</strong> Name,
                                    email address, and other contact information
                                    when you register or sign in using Epic
                                    Games or other third-party providers.
                                </li>
                                <li>
                                    <strong>Usage Data:</strong> Information
                                    about your internet connection, the
                                    equipment you use to access our Application,
                                    and usage details.
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc space-y-1 pl-6">
                                <li>
                                    To present our Application and its contents
                                    to you.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    Application or any products or services we
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                or serving our users, so long as those parties
                        ...
                        <section>
                            ...
                            <p>
                                We have implemented measures designed to secure
                                your personal information from accidental loss
                                and from unauthorized access, use, alteration,
                                and disclosure. All information you provide to
                                us is stored on our secure servers behind
                                firewalls.
                            </p>
                        </section>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-semibold text-foreground">
                                6. Epic Games Store Requirements
                            </h2>
                            <p>
                                If you access our Application via the Epic Games
                                Store, we comply with relevant Epic Games
                                privacy requirements, including obtaining your
                                explicit consent for data access. We only access
                                data (such as profile, friends list, or
                                presence) that you explicitly authorize. We
                                respect your privacy choices and do not process
                                data in ways that contradict your permissions.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                Our Application is not intended for children
                                under 13 years of age. No one under age 13 may
                                provide any personal information to or on the
                                Application. We do not knowingly collect
